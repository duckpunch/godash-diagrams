...
export function boardToSvg(
  ...
  let svg = `<svg class="godash-board" viewBox="0 0 ${svgWidth} ${svgHeight}" style="max-width: 500px; width: 100%; height: auto; display: block;" xmlns="http://www.w3.org/2000/svg">`
